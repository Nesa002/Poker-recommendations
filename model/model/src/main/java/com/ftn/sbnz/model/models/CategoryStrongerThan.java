...
public class CategoryStrongerThan {
    ...
    public boolean equals(Object o) {
        ...
        CategoryStrongerThan that = (CategoryStrongerThan) o;
        return java.util.Objects.equals(stronger, that.stronger) &&
               java.util.Objects.equals(weaker, that.weaker);
    }

    @Override
    public int hashCode() {
        return java.util.Objects.hash(stronger, weaker);
    }
}